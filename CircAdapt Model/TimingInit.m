...
a  = cell2mat(P.Patch.Name')=='a'; %find letter 'a'
iP = (1:P.Patch.n)'; a2=a(:,2); %logical vector: letter 'a' on 2nd position
iPa= iP( a2)';%atrial patches
iPv= iP(~a2)';%ventricular patches
...
P.Net.Depolarization.TauInterPatch= 0.01 ; % default interpatch delay
